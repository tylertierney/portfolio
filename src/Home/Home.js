...
import resume from "../tierneyresume_21.pdf";
    ...
    <section className="home" style={{ backgroundColor: theme.blueBackground }}>
      <div className="homeContainer">
        <div
          ...
          style={{ boxShadow: theme.headshotBoxShadow }}
        ></div>
        <div className="homeTextElemsContainer">
          <p className="homeTextElems" style={{ color: theme.text }}>
            Tyler Tierney
          </p>
          <p className="homeTextElems" style={{ color: theme.text }}>
            Software Developer
